...
- `docs/reports/current/CODEX_MDOT5_ENDPOINT_VALIDITY_AND_EXPONENT_AUDIT_RESULTS.md`
- `docs/reports/current/CODEX_MDOT5_ANGULAR_MOMENTUM_LEDGER_RESULTS.md`
- `docs/reports/current/CODEX_MDOT5_INDEPENDENT_OUTER_MANIFOLD_RESULTS.md`
- `docs/reports/current/CODEX_IMBH_REPOSITORY_CLEANUP_SPEC_2026-07-10.md`
