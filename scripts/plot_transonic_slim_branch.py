...
def solve_rows():
    ...
    ratios = np.array([1.0e-3, 1.0e-2, 0.1, 1.0])
    rows = []
...
def draw_figure(rows) -> None:
    ...
    draw_text(draw, (80, 104), "Pseudo-Newtonian, isolated no-wind collocation; finite-difference local partials.", subtitle_font, (78, 84, 96))
