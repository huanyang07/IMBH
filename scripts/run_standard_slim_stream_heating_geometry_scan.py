...
def params_for(
    ...
    *,
    ...
    return TransonicSlimParams(
        ...
        stream_mass_center_fraction=float(center_fraction),
        stream_mass_log_width=float(log_width),
...
def source_diagnostics(z: np.ndarray, params: TransonicSlimParams) -> dict[str, float]:
    ...
    return {
        "Rinj_rg": float(params.stream_mass_center_fraction * params.R_out_rg),
