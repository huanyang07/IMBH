...
def params_for(
    ...
    *,
    ...
    return TransonicSlimParams(
        ...
        wind_sink_shape=str(wind_sink_shape).strip().lower(),
        wind_sink_powerlaw_inner_rg=float(wind_sink_powerlaw_inner_rg),
        wind_sink_powerlaw_s=float(wind_sink_powerlaw_s),
...
def load_anchor(path: Path, fiducial: FiducialParams, mdot_edd: float) -> tuple[np.ndarray, TransonicSlimParams]:
    ...
    params = params_for(
        ...
        wind_sink_shape=str(scalar_from_data(data, "wind_sink_shape", "tanh")),
        wind_sink_powerlaw_inner_rg=float(scalar_from_data(data, "wind_sink_powerlaw_inner_rg", 5.0)),
        wind_sink_powerlaw_s=float(scalar_from_data(data, "wind_sink_powerlaw_s", 1.0)),
...
def row_for_result(
    *,
    ...
    return {
        ...
        "wind_sink_powerlaw_inner_rg": float(params.wind_sink_powerlaw_inner_rg),
...
def run_branch(
    *,
    ...
    for mass_fraction in mass_fractions:
        ...
        wind_sink_shape=current_params.wind_sink_shape,
        wind_sink_powerlaw_inner_rg=current_params.wind_sink_powerlaw_inner_rg,
        wind_sink_powerlaw_s=current_params.wind_sink_powerlaw_s,
