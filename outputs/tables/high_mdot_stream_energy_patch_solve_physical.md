...
Windows `298:5`, top-K `0`, node pad `0`, energy weight `5`, prior weight `0.0001`.
...
Local patch max residual: `8.958686e-10` -> `1.005915e-11` in `4` function evaluations.

Patched checkpoint `outputs/checkpoints/high_mdot_stream_energy_patch_solve_physical/energy_patch_mass_0p8985_N896.npz`.
